...
⚠️ Important, a WIFI connection is needed to install the required libraries!
...
Finally, if you are having issues, you can run an audit with option `6`, read an audit with option `8`, or play a test chime with option `7`. The log lives at `/home/ark/bt_audit.log`.
